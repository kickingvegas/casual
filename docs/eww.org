...
This menu (~casual-eww-display-tmenu~) provides commands to toggle different display attributes of a web page.
...
This menu (~casual-eww-bookmarks-tmenu~) provides commands for managing the EWW bookmark list.
